  ...
  return <View>
    <View className={clnx(['margin_box'])}>
      <View className={clnx(['padding1', 'yellow-bg1'])}>
        <Text className={clnx(['font-size_75', 'black2'])}>stretch: 默认 如果 flex 元素未设置高度或设为auto，将占满整个容器的高度</Text>
      </View>
      ...
      <View className={clnx(['padding1', 'yellow-bg1'])}>
        <Text className={clnx(['font-size_75', 'black2'])}>baseline flex 元素的第一行文字的基线对齐 (RN/快应用 不支持)</Text>
      </View>
