  ...
  return <View>
    <View className={clnx(['margin_box'])}>
      <View className={clnx(['padding1', 'yellow-bg1'])}>
        <Text className={clnx(['font-size_75', 'black2'])}>flex-start: 默认 左对齐</Text>
      </View>
      <JustifyContent justifyContent='flex-start' />
      <View className={clnx(['padding1', 'yellow-bg1'])}>
        <Text className={clnx(['font-size_75', 'black2'])}>flex-end 右对齐</Text>
      </View>
      <JustifyContent justifyContent='flex-end' />
      <View className={clnx(['padding1', 'yellow-bg1'])}>
        <Text className={clnx(['font-size_75', 'black2'])}>center 居中</Text>
      </View>
