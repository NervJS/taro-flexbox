  ...
  return <View>
    <View className={clnx(['margin_box'])}>
      ...
      <View className={clnx(['flex', 'brand_blue-bg_5', 'padding_10', 'max-height15', 'flex-row'])}>
        ...
        <View className={clnx(['flex', 'height2', 'width4', 'brand_blue-bg', 'margin_10', 'align-center'])} style={styles.flex_1}>
          <Text className={clnx(['cream', 'font-size_75', 'line-height1', 'margin_auto', 'text_center'])}>1 1 auto</Text>
        </View>
      </View>
    </View>
    <View className={clnx(['margin_box'])}>
      <View className={clnx(['flex', 'brand_blue-bg_5', 'padding_10', 'max-height15', 'flex-row'])}>
        <View className={clnx(['flex', 'height2', 'width4', 'brand_blue-bg', 'margin_10', 'align-center'])} style={styles.flex_none}>
          <Text className={clnx(['cream', 'font-size_75', 'line-height1', 'margin_auto', 'text_center'])}>none</Text>
        </View>
        <View className={clnx(['flex', 'height2', 'width4', 'brand_blue-bg', 'margin_10', 'align-center'])} style={styles.flex_0}>
          <Text className={clnx(['cream', 'font-size_75', 'line-height1', 'margin_auto', 'text_center'])}>0 0 auto</Text>
        </View>
      </View>
    </View>
  </View>
