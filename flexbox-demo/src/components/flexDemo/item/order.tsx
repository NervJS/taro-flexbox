  ...
  return <View>
    <View className={clnx(['margin_box'])}>
      ...
      <View className={clnx(['flex', 'blue-bg3', 'padding_10', 'max-height15', 'flex-row'])}>
        <View className={clnx(['flex', 'width4', 'borderW', 'blue-bg2', 'margin_10', 'align-center'])} style={styles.order}>
          <View className={clnx(['margin_auto'])}><OrderLabel index={1} order={0}/></View>
        </View>
        <View className={clnx(['flex', 'width4', 'borderW', 'blue-bg2', 'margin_10', 'align-center'])} style={styles.order2}>
          <View className={clnx(['margin_auto'])}><OrderLabel index={2} order={2}/></View>
        </View>
        <View className={clnx(['flex', 'width4', 'borderW', 'blue-bg2', 'margin_10', 'align-center'])} style={styles.order4}>
    ...
    <View className={clnx(['margin_box'])}>
      <View className={clnx(['flex', 'blue-bg3', 'padding_10', 'max-height15', 'flex-row'])}>
        ...
        <View className={clnx(['flex', 'width4', 'borderW', 'blue-bg2', 'margin_10', 'align-center'])} style={styles.order_1}>
          <View className={clnx(['margin_auto'])}><OrderLabel index={2} order={-1}/></View>
        </View>
        <View className={clnx(['flex', 'width4', 'borderW', 'blue-bg2', 'margin_10', 'align-center'])} style={styles.order1}>
